...
interface VerifyPasswordInterface {
  verifyTwoStep: boolean;
  handleBackToSettings: () => void;
  handleCloseAllMenu: () => void;
  handleVerfyPassword: () => void;
  darkMode: boolean;
  handeleTwoStepPasswordChange: (
...
const VerifyCloudPasswordComponent: React.FC<VerifyPasswordInterface> = ({
  verifyTwoStep,
...
export default VerifyCloudPasswordComponent;
